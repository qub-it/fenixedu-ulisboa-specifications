...
<%@ page import="org.fenixedu.academic.dto.teacher.executionCourse.NextPossibleSummaryLessonsAndDatesBean" %>
<%@ page import="org.fenixedu.ulisboa.specifications.domain.services.teacher.SummaryServices" %>
...
<logic:present name="showSummariesBean">
	...
	<%-- UL specification --%>
	<bean:define id="nextPossibleLessonsDates" name="nextPossibleLessonsDates" type="java.util.Collection" />
	<%
		pageContext.setAttribute("filtered", SummaryServices.filterSummariesManagementForLoggedPerson((java.util.Collection<NextPossibleSummaryLessonsAndDatesBean>)nextPossibleLessonsDates));
	%>	
		<logic:notEmpty name="filtered">			
			...
			<fr:form action="/summariesManagement.do?method=prepareCreateComplexSummary">			
				...
				<fr:view name="filtered" schema="PossibleNextSummaryLessonAndDate">
		...
		<logic:iterate name="summaries" id="summary">					
			...
			<strong>
				<logic:equal name="summary" property="taught" value="true">
					<fr:view name="summary" property="title" type="org.fenixedu.commons.i18n.LocalizedString"/>
				</logic:equal>
			...
			<logic:equal name="showSummariesBean" property="listSummaryType" value="ALL_CONTENT">				
				<p class="mvert05">
					<fr:view name="summary" property="summaryText" type="org.fenixedu.commons.i18n.LocalizedString" layout="html" />					
				</p>
			</logic:equal>	
