...
<logic:present name="showSummariesCalendarBean">
	...
	<fr:form action="/summariesManagement.do?method=showSummariesCalendarPostBack">
		<fr:edit id="showSummariesCalendar" name="showSummariesCalendarBean" schema="ShowSummariesCalendarOverride" nested="true">
	...
	<%-- UL specification --%>
	<bean:define id="summariesCalendarResult" name="summariesCalendarResult" type="java.util.Collection" />
	<%
		pageContext.setAttribute("filtered", SummaryServices.filterSummariesManagementForLoggedPerson((java.util.Collection<NextPossibleSummaryLessonsAndDatesBean>)summariesCalendarResult));
	%>
		...
		<fr:view name="filtered" schema="SummariesCalendarList">
			<fr:layout name="tabular">
