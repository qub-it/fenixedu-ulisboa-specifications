...
<logic:present name="summariesManagementBean">
	...
	<table class="tstyle5">
		...
		<tr>
			...
			<td>
				<%-- UL specification: schema="ListShiftsToCreateSummaryOverride" --%>
				<%-- Shift --%>						
				<fr:form action="/summariesManagement.do?method=chooseShift">
					<fr:edit id="summariesManagementBeanWithShifts" name="summariesManagementBean" schema="ListShiftsToCreateSummaryOverride" nested="true">
