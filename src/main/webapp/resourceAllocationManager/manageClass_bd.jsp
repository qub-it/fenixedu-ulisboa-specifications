	...
	<table class="tstyle4 thlight tdcenter mtop05">
		...
		<tr>
			...
			<logic:notEqual name="numberOfLessons" value="0">
				...
				<bean:define id="shift" name="infoShift" property="shift" type="org.fenixedu.academic.domain.Shift"/>
				<%= shift.getStudentsSet().size() %> / <bean:write name="infoShift" property="lotacao"/>
            </td>
