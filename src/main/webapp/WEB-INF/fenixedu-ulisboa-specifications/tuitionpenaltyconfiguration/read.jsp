...
<div class="page-header">
	<h1>
		<spring:message code="label.TuitionPenaltyConfiguration.title" />
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	...
	&nbsp;
	<a class="" href="${pageContext.request.contextPath}<%= TuitionPenaltyConfigurationController.EDIT_URL %>">
			...
			<table class="table">
				<tbody>
					<tr>
						...
						<td>
							<c:out value='${tuitionPenaltyConfiguration.tuitionPenaltyServiceRequestType.name.content}' />
						</td>
					</tr>
					<tr>
						<th scope="row" class="col-xs-3">
