...
<form name='form' method="post" class="form-horizontal" ng-app="angularApp" ng-controller="angularController" ng-submit="form.$valid"
    ...
    <div class="panel panel-default">
        <div class="panel-body">        
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message code="label.AcademicEnrolmentPeriod.specialSeason" />
                </div>

                <div class="col-sm-10">
                    <ui-select id="academicEnrolmentPeriod_specialSeason" name="specialSeason"
                        ng-model="$parent.object.specialSeason"
                        theme="bootstrap"> 
                        <ui-select-match>
