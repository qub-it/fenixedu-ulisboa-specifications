...
<div class="page-header">
	<h1><spring:message code="label.manageMobilityRegistrationInformation.updateMobilityRegistrationInformation" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/specifications/managemobilityregistrationinformation/mobilityregistrationinformation/read/${mobilityRegistrationInformation.externalId}" ><spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;</div>
...
<form name='form' method="post" class="form-horizontal"
	...
	action='${pageContext.request.contextPath}/specifications/managemobilityregistrationinformation/mobilityregistrationinformation/update/${mobilityRegistrationInformation.externalId}'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}specifications/managemobilityregistrationinformation/mobilityregistrationinformation/updatepostback/${mobilityRegistrationInformation.externalId}' />
