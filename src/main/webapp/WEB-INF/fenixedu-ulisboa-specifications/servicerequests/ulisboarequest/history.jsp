 ...
 */
 -->
<%@page import="org.fenixedu.qubdocs.ui.academicrequest.AcademicRequestManagementController"%>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">
            <spring:message code="label.academicRequest.registrationDetails" />
        </h3>
    </div>
    <div class="panel-body">
        <form method="post" class="form-horizontal">
            <table class="table">
                <tbody>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message code="label.startDate" /></th>
                        <td><joda:format value='${registration.startDate}' style='S-' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message code="label.number" /></th>
                        <td><c:out value='${registration.number}' /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message code="label.degree" /></th>
                    ...
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message code="label.numberEnroledCurricularCoursesInCurrentYear" /></th>
...
<c:choose>
    <c:when test="${not empty registration.historicalAcademicServiceRequests}">
        <table id="historicAcademicServiceRequestsTable"
            ...
            <thead>
                <tr>
                    ...
                    <th><spring:message code="label.academicRequest.urgentRequest" /></th>
                    ...
                    <th><spring:message code="label.academicRequest.executionYear" /></th>
                    <th><spring:message code="label.academicRequest.language" /></th>
...
<script>
    var historicAcademicServiceRequestsDataSet = [
        <c:forEach items="${registration.historicalAcademicServiceRequests}" var="request">
        {
            ...
            "urgentRequest" : '<c:out value='${request.urgentRequest}'/>',
            "serviceRequestNumberYear" : '<c:out value='${request.serviceRequestNumberYear}'/>',
            "description" : '<c:out value='${request.description}'/>',
            "executionYear" : '<c:out value='${request.executionYear.year}'/>',
            "language" : '<c:out value='${request.language.displayName}'/>',
            "academicServiceRequestSituationType" : '<c:out value='${request.academicServiceRequestSituationType.localizedName}'/>',
            "actions" :
                " <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}\"><spring:message code='label.view'/></a>" +
    ...
    $(document).ready(function() {
        ...
        "data" : historicAcademicServiceRequestsDataSet,
