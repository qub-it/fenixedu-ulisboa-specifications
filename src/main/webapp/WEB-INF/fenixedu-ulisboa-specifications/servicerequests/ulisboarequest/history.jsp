...
<script>
    var uLisboaServiceRequestsDataSet = [
        <c:forEach items="${uLisboaServiceRequestList}" var="request">
        {
            ...
            "actions" :
            	<% if (AcademicAuthorizationGroup.get(AcademicOperationType.SERVICE_REQUESTS).isMember(AccessControl.getPerson().getUser()) || PermissionService.hasAccess("ACADEMIC_REQUISITIONS", AccessControl.getPerson().getUser())) {%>
