...
<%@page import="org.fenixedu.academic.domain.evaluation.markSheet.CompetenceCourseMarkSheetChangeRequest"%>
			...
			<table id="changeRequestsDataTable" class="table table-bordered table-hover" width="100%">
				...
				<tbody>
					...
					<tr>
                        ...
                        <td><c:out value="<%=CompetenceCourseMarkSheetBean.getPersonDescription(((CompetenceCourseMarkSheetChangeRequest)pageContext.getAttribute("changeRequest")).getRequester())%>"></c:out></td>
						<td><pre style="border:none;background-color: inherit;white-space: pre-wrap;"><c:out value="${changeRequest.reason}" /></pre></td>
                        <td><c:out value="<%=CompetenceCourseMarkSheetBean.getPersonDescription(((CompetenceCourseMarkSheetChangeRequest)pageContext.getAttribute("changeRequest")).getResponder())%>"></c:out></td>
