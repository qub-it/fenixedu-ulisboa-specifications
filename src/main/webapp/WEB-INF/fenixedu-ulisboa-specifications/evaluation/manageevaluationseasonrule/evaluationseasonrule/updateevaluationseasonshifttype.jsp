	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group row">
                ...
                <div class="col-sm-6">
                    <ui-select  id="shiftTypesSelect" name="shiftTypes" ng-model="$parent.object.shiftTypes" theme="bootstrap"  multiple="true">
                        <ui-select-match>{{$item.text}}</ui-select-match> 
                        <ui-select-choices  repeat="shiftType.id as shiftType in object.shiftTypesDataSource | filter: $select.search">
                            <span ng-bind-html="shiftType.text | highlight: $select.search"></span>
                        </ui-select-choices> 
                    </ui-select>
                </div>
			</div>
