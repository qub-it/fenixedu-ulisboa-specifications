...
<form id="createForm" name='form' method="post" class="form-horizontal"
    ...
    action='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.CREATEEVALUATIONSEASONSTATUTETYPE_URL%>'>

    <input type="hidden" name="postback"
        value='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.CREATEEVALUATIONSEASONSTATUTETYPEPOSTBACK_URL%>' />
