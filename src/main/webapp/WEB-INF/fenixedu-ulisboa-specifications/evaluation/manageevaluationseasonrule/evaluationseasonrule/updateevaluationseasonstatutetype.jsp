...
<form id="updateForm" name='form' method="post" class="form-horizontal"
    ...
    action='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.UPDATEEVALUATIONSEASONSTATUTETYPE_URL%>'>

    <input type="hidden" name="postback"
        value='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.UPDATEEVALUATIONSEASONSTATUTETYPEPOSTBACK_URL%>' />
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <ui-select  id="statuteTypesSelect" name="statuteTypes" ng-model="$parent.object.statuteTypes" theme="bootstrap"  multiple="true">
                        <ui-select-match>{{$item.text}}</ui-select-match> 
                        <ui-select-choices  repeat="statuteType.id as statuteType in object.statuteTypesDataSource | filter: $select.search">
