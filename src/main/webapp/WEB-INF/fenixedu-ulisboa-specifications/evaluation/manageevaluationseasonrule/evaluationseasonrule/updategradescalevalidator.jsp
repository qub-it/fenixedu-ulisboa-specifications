...
<form id="updateForm" name='form' method="post" class="form-horizontal"
	...
	action='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.UPDATEGRADESCALEVALIDATOR_URL%>${evaluationSeasonRule.externalId}'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.UPDATEGRADESCALEVALIDATORPOSTBACK_URL%>${evaluationSeasonRule.externalId}' />
