...
<div class="page-header">
	<h1>
		<spring:message
			code="label.evaluation.config.manageMarkSheetSettings.updateTemplateFile" />
		<small></small>
	</h1>
</div>
...
<form name='form' method="post" class="form-horizontal"
	action='${pageContext.request.contextPath}<%=MarkSheetSettingsController.UPDATETEMPLATEFILE_URL%>${markSheetSettings.externalId}'
		...
		<div class="panel-body">
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.MarkSheetSettings.templateFile" />
				</div>

				<div class="col-sm-4">
					<input type="file" name="templateFile" required accept=".odt"/>
				</div>
			</div>
		</div>
