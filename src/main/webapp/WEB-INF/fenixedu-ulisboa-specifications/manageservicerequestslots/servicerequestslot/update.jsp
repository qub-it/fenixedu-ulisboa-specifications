...
<div class="page-header">
    <h1>
        <spring:message
            code="label.manageServiceRequestSlots.updateServiceRequestSlot" />
        <small></small>
    </h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}<%= ServiceRequestSlotController.READ_URL %>${serviceRequestSlot.externalId}"><spring:message
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="serviceRequestSlot_code" class="form-control" type="text" name="code" value='<c:out value='${not empty param.code ? param.code : serviceRequestSlot.code }'/>' required />
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-2 control-label">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="serviceRequestSlot_label" class="form-control" type="text" name="label" bennu-localized-string value='${not empty param.label ? param.label : serviceRequestSlot.label } ' />
                </div>
            </div>            
        </div>
