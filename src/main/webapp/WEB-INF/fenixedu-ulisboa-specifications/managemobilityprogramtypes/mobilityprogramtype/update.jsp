...
<div class="page-header">
	<h1>
		<spring:message code="label.manageMobilityProgramTypes.updateMobilityProgramType" />
		<small></small>
	</h1>
</div>
...
<form name='form' method="post" class="form-horizontal" ng-app="angularAppMobilityProgramType" ng-controller="MobilityProgramTypeController"
	action='${pageContext.request.contextPath}<%= MobilityProgramTypeController.UPDATE_URL %>/${mobilityProgramType.externalId}'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}<%= MobilityProgramTypeController.UPDATE_URL %>/${mobilityProgramType.externalId}' />
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<select id="mobilityProgramType_active" name="active" class="form-control" ng-model="object.active"
