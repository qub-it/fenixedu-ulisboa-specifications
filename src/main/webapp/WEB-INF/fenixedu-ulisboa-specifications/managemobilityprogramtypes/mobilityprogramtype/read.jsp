...
<div class="page-header">
	<h1>
		<spring:message
			code="label.manageMobilityProgramTypes.readMobilityProgramType" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	...
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
		class=""
		href="${pageContext.request.contextPath}<%= MobilityProgramTypeController.SEARCH_URL %>">
		<spring:message code="label.event.back" /></a>

	&nbsp;|&nbsp;
	
	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<a
		class="" href="${pageContext.request.contextPath}<%= MobilityProgramTypeController.UPDATE_URL %>/${mobilityProgramType.externalId}">
				...
				<tbody>
					<tr>
						<th scope="row" class="col-xs-3"><spring:message
								code="label.MobilityProgramType.code" /></th>
						<td><c:out value='${mobilityProgramType.code}' /></td>
					</tr>
					<tr>
						<th scope="row" class="col-xs-3"><spring:message
								code="label.MobilityProgramType.name" /></th>
						<td><c:out value='${mobilityProgramType.name.content}' /></td>
					</tr>
					<tr>
						<th scope="row" class="col-xs-3"><spring:message
								code="label.MobilityProgramType.active" /></th>
						<td><c:if test="${mobilityProgramType.active}">
								<spring:message code="label.true" />
						</c:if>
							<c:if test="${not mobilityProgramType.active}">
