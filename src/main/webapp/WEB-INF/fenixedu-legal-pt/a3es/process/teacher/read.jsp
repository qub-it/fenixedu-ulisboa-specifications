...
<div ng-app="angularAppA3esProcess" ng-controller="A3esProcessTeacherController">
	...
	<div class="well well-sm" style="display: inline-block">
		...
		&nbsp;|&nbsp; <span class="glyphicon glyphicon-book" aria-hidden="true"></span>&nbsp;<a class=""
			href="${pageContext.request.contextPath}<%=A3esProcessTeacherController.READ_URL%>${process.externalId}/viewcourses/"><spring:message
