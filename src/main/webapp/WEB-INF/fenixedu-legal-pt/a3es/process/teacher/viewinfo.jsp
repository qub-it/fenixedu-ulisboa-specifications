...
<script type="text/javascript">
	angular.module('angularAppA3esProcess',
			...
			'A3esProcessTeacherController', [ '$scope', function($scope) {
...
<form id="exportForm" name='form' method="post" class="form-horizontal" ng-app="angularAppA3esProcess"
	ng-controller="A3esProcessTeacherController" action='#'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}<%=A3esProcessTeacherController.VIEWINFOPOSTBACK_URL%>${process.externalId}' /> <input
