<%@page import="org.fenixedu.legalpt.ui.a3es.A3esLegalMappingsController"%>
...
function openDeleteModal(externalId) {
    url = "${pageContext.request.contextPath}<%= A3esLegalMappingsController.DELETE_URL %>/" + externalId;
...
<div class="modal fade" id="createModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="createLegalMappingForm" action="${pageContext.request.contextPath}<%= A3esLegalMappingsController.CREATE_URL%>" method="POST">
...
<div class="page-header">
    <h1>
    	<spring:message code="label.manageA3esLegalMapping.search" />
        <small></small>
    </h1>
</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-default btn-xs"
                                        href="${pageContext.request.contextPath}<%= A3esLegalMappingsController.SEARCH_VIEW_URL %>/${ legalMapping.externalId }">
