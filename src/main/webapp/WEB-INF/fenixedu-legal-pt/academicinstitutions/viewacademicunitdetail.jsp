...
<div class="page-header">
	<h1>
		<spring:message
			code="label.AcademicInstitutionsController.viewacademicunits.title" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	...
	<a class=""
		href="${pageContext.request.contextPath}<%= AcademicInstitutionsController.VIEW_ACADEMIC_UNITS_URL %>">
