...
public class IngressionRegimeMappingController extends SasBaseController {
    ...
    public String create(@RequestParam(value = "ingression", required = false) IngressionType ingressionType,
        ...
        try {
            ...
            addErrorMessage(BundleUtil.getString(AbstractFillScholarshipService.SAS_BUNDLE, "label.error.create", de.getLocalizedMessage()),
                    model);
            return create(model);
        }
    }
    ...
    public String processSearchToDeleteAction(@PathVariable("oid") SasIngressionRegimeMapping ingressionRegimeMapping, Model model,
        ...
        try {
            ...
            addInfoMessage(BundleUtil.getString(AbstractFillScholarshipService.SAS_BUNDLE, "label.manageIngressionRegimeMapping.success.delete"), model);
            return redirect("/integration/sas/manageIngressionRegimeMapping/", model, redirectAttributes);
        } catch (Exception ex) {
            addErrorMessage(BundleUtil.getString(AbstractFillScholarshipService.SAS_BUNDLE, "label.error.update", ex.getLocalizedMessage()),
                    model);
        }
    ...
    public String update(@PathVariable("oid") SasIngressionRegimeMapping ingressionRegimeMapping, @RequestParam(value = "ingression",
        ...
        try {
            ...
            addErrorMessage(BundleUtil.getString(AbstractFillScholarshipService.SAS_BUNDLE, "label.error.update") + de.getLocalizedMessage(),
                    model);
