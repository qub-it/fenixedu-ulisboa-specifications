...
public class FATypeQualitativeGradeScaleLogic implements GradeScaleLogic {
    ...
    private static final List<String> SORTED_GRADES =
            Arrays.asList(RE, R, RM, A, SU, ABU, AD, ADL, B, ABM, MB, AMBM, AMBU, AMBD, AMB, E);
    ...
    static {
        ...
        CONFIGURATION.put(RM,
                new LocalizedString(Locale.getDefault(), "Recusado(a) Maioria").with(Locale.ENGLISH, "Refused by Majority"));
        ...
        CONFIGURATION.put(ABU, new LocalizedString(Locale.getDefault(), "Aprovado(a) Bom, por Unanimidade").with(Locale.ENGLISH,
                "Approved Good by Unanimity"));
        CONFIGURATION.put(AD, new LocalizedString(Locale.getDefault(), "Aprovado(a) com Distinção").with(Locale.ENGLISH,
                "Approved with Distinction"));
        CONFIGURATION.put(ADL, new LocalizedString(Locale.getDefault(), "Aprovado(a)  com Distinção e Louvor")
                .with(Locale.ENGLISH, "Approved with Distinction and Honors"));
        CONFIGURATION.put(B, new LocalizedString(Locale.getDefault(), "Bom").with(Locale.ENGLISH, "Good"));
        CONFIGURATION.put(ABM, new LocalizedString(Locale.getDefault(), "Aprovado(a) Bom, por Maioria").with(Locale.ENGLISH,
                "Approved Good by Majority"));
        CONFIGURATION.put(MB, new LocalizedString(Locale.getDefault(), "Muito Bom").with(Locale.ENGLISH, "Very good"));
        CONFIGURATION.put(AMBM, new LocalizedString(Locale.getDefault(), "Aprovado(a) Muito Bom, por Maioria")
                .with(Locale.ENGLISH, "Approved Very Good by Majority"));
        CONFIGURATION.put(AMBU, new LocalizedString(Locale.getDefault(), "Aprovado(a) Muito Bom, por Unanimidade")
                .with(Locale.ENGLISH, "Approved Very Good by Unanimity"));
        CONFIGURATION.put(AMBD, new LocalizedString(Locale.getDefault(), "Aprovado(a) Muito Bom, com Distinção")
                .with(Locale.ENGLISH, "Approved Very Good with Distinction"));
        CONFIGURATION.put(AMB,
                new LocalizedString(Locale.getDefault(), "Aprovado(a) Muito Bom").with(Locale.ENGLISH, "Approved Very Good"));
