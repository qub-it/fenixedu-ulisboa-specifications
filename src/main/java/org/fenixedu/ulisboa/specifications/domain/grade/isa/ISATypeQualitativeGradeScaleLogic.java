...
public class ISATypeQualitativeGradeScaleLogic implements GradeScaleLogic {
    ...
    static {
        ...
        CONFIGURATION.put(APDL, new LocalizedString(Locale.getDefault(), "Aprovado com Distinção e Louvor").with(Locale.ENGLISH, "Approved with Distinction and Honors"));
        CONFIGURATION.put(APD, new LocalizedString(Locale.getDefault(), "Aprovado com Distinção").with(Locale.ENGLISH, "Approved with Distinction"));
        CONFIGURATION.put(APMBD, new LocalizedString(Locale.getDefault(), "Aprovado com Muito Bom com Distinção").with(Locale.ENGLISH, "Approved Very Good with Distinction"));
        CONFIGURATION.put(APMB, new LocalizedString(Locale.getDefault(), "Aprovado com Muito Bom").with(Locale.ENGLISH, "Approved with Very Good"));
        CONFIGURATION.put(APB, new LocalizedString(Locale.getDefault(), "Aprovado com Bom").with(Locale.ENGLISH, "Approved with Good"));
