...
public class AcademicEnrolmentPeriodBean implements IBean {
    ...
    private Integer curricularYear = 0;
    ...
    public void setExecutionSemesterDataSource(List<ExecutionSemester> executionSemesters) {
        this.executionSemesterDataSource = executionSemesters.stream()
                .sorted((e1, e2) -> ExecutionSemester.COMPARATOR_BY_BEGIN_DATE.compare(e2, e1)).map(semester -> {
                    TupleDataSourceBean tuple = new TupleDataSourceBean();
