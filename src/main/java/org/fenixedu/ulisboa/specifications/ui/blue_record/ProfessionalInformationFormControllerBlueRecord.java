...
@RequestMapping(ProfessionalInformationFormControllerBlueRecord.CONTROLLER_URL)
public class ProfessionalInformationFormControllerBlueRecord extends ProfessionalInformationFormController {

    public static final String CONTROLLER_URL =
            "/fenixedu-ulisboa-specifications/blueRecord/{executionYearId}/professionalinformationform";
    ...
    public String backScreen(@PathVariable("executionYearId") final ExecutionYear executionYear, final Model model,
        ...
        return redirect(urlWithExecutionYear(HouseholdInformationUlisboaFormControllerBlueRecord.INVOKE_BACK_URL, executionYear),
    ...
    public boolean isFormIsFilled(final ExecutionYear executionYear, final Student student) {
        ...
        boolean result = validateForm(createProfissionalInformationForm(student, executionYear, false)).isEmpty();
        return result && personUl.isFormAnswered(ProfessionalInformationFormControllerBlueRecord.class.getSimpleName());
    }
