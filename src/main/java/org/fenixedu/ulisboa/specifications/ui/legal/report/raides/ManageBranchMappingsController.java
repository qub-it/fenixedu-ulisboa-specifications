...
@SpringFunctionality(app = FenixeduUlisboaSpecificationsController.class, title = "label.title.manageBranchMappings",
        accessGroup = "logged")
@RequestMapping(ManageBranchMappingsController.CONTROLLER_URL)
public class ManageBranchMappingsController extends FenixeduUlisboaSpecificationsBaseController {

    public static final String CONTROLLER_URL = "/fenixedu-ulisboa-specifications/managebranchmappings";
    public static final String JSP_PATH = "fenixedu-ulisboa-specifications/managebranchmappings";
    ...
    public String view(@PathVariable("degreeCurricularPlanId") final DegreeCurricularPlan degreeCurricularPlan, final Model model) {
    ...
    private void addMapping(final BranchMappingEntryBean bean) {
        BranchMappingType.readMapping(RaidesInstance.getInstance()).addEntry(
                BranchMappingType.readMapping(RaidesInstance.getInstance()).keyForObject(bean.getBranchKey()),
                bean.getValue());
    }
