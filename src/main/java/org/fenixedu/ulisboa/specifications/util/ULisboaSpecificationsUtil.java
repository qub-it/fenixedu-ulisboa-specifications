...
public class ULisboaSpecificationsUtil {
    ...
    public static String bundle(final String key, final String... args) {
        return BundleUtil.getString(ULisboaSpecificationsUtil.BUNDLE, key, args);
    }

    public static LocalizedString bundleI18N(final String key, final String... args) {
        return BundleUtil.getLocalizedString(ULisboaSpecificationsUtil.BUNDLE, key, args);
    }
